...
var format_jenis_tanah_5 = new ol.format.GeoJSON();
var features_jenis_tanah_5 = format_jenis_tanah_5.readFeatures(json_jenis_tanah_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_jenis_tanah_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_jenis_tanah_5.addFeatures(features_jenis_tanah_5);
var lyr_jenis_tanah_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_jenis_tanah_5, 
                style: style_jenis_tanah_5,
                interactive: true,
    title: 'jenis_tanah<br />\
    <img src="styles/legend/jenis_tanah_5_0.png" /> Sulfaquents; Hydraquents<br />\
    <img src="styles/legend/jenis_tanah_5_1.png" /> Tropaquepts; Fluvaquents; Tropohemist<br />\
    <img src="styles/legend/jenis_tanah_5_2.png" /> Tropudults; Dystropepts<br />\
    <img src="styles/legend/jenis_tanah_5_3.png" /> Tropudults; Tropaquepts<br />'
        });
...
var format_BATAS_RESORT_TNKUTAI_4194_21 = new ol.format.GeoJSON();
var features_BATAS_RESORT_TNKUTAI_4194_21 = format_BATAS_RESORT_TNKUTAI_4194_21.readFeatures(json_BATAS_RESORT_TNKUTAI_4194_21, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BATAS_RESORT_TNKUTAI_4194_21 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BATAS_RESORT_TNKUTAI_4194_21.addFeatures(features_BATAS_RESORT_TNKUTAI_4194_21);
var lyr_BATAS_RESORT_TNKUTAI_4194_21 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_BATAS_RESORT_TNKUTAI_4194_21, 
                style: style_BATAS_RESORT_TNKUTAI_4194_21,
                interactive: true,
                title: '<img src="styles/legend/BATAS_RESORT_TNKUTAI_4194_21.png" /> BATAS_RESORT_TNKUTAI_4194'
            });
var format_SK_LOKASi_FSP_22 = new ol.format.GeoJSON();
var features_SK_LOKASi_FSP_22 = format_SK_LOKASi_FSP_22.readFeatures(json_SK_LOKASi_FSP_22, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SK_LOKASi_FSP_22 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SK_LOKASi_FSP_22.addFeatures(features_SK_LOKASi_FSP_22);
var lyr_SK_LOKASi_FSP_22 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_SK_LOKASi_FSP_22, 
                style: style_SK_LOKASi_FSP_22,
                interactive: true,
                title: '<img src="styles/legend/SK_LOKASi_FSP_22.png" /> SK_LOKASi_FSP'
            });
var format_RehabDASdiTNKutai_IPPKH_23 = new ol.format.GeoJSON();
var features_RehabDASdiTNKutai_IPPKH_23 = format_RehabDASdiTNKutai_IPPKH_23.readFeatures(json_RehabDASdiTNKutai_IPPKH_23, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RehabDASdiTNKutai_IPPKH_23 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RehabDASdiTNKutai_IPPKH_23.addFeatures(features_RehabDASdiTNKutai_IPPKH_23);
var lyr_RehabDASdiTNKutai_IPPKH_23 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_RehabDASdiTNKutai_IPPKH_23, 
                style: style_RehabDASdiTNKutai_IPPKH_23,
                interactive: true,
                title: '<img src="styles/legend/RehabDASdiTNKutai_IPPKH_23.png" /> Rehab DAS di TN Kutai_IPPKH'
            });
...
lyr_OpenStreetMap_0.setVisible(false);lyr_google_1.setVisible(true);lyr_Topografi_2.setVisible(false);lyr_PrioritasRehabilitasiReplantingTinggimerahSedangkuningRendahHijau_3.setVisible(false);lyr_Analisispotensiancamandankonfliklahan_4.setVisible(false);lyr_jenis_tanah_5.setVisible(false);lyr_TUTUPAN_LAHAN_6.setVisible(true);lyr_ZonasiTNKutai_7.setVisible(false);lyr_KARET_8.setVisible(false);lyr_TANAHTERBUKA_9.setVisible(false);lyr_PERTANIAN_LAHAN_KERING_CAMPURAN_10.setVisible(false);lyr_BANGUNAN_11.setVisible(false);lyr_SAWAH_12.setVisible(false);lyr_SAWIT_13.setVisible(false);lyr_TAMBAK_14.setVisible(false);lyr_Jalan_15.setVisible(false);lyr_GeologiLitologi_16.setVisible(false);lyr_GeologiStruktur_17.setVisible(false);lyr_BatasDas_18.setVisible(false);lyr_SubDas_19.setVisible(false);lyr_BATASTNKUTAI4194_20.setVisible(true);lyr_BATAS_RESORT_TNKUTAI_4194_21.setVisible(false);lyr_SK_LOKASi_FSP_22.setVisible(false);lyr_RehabDASdiTNKutai_IPPKH_23.setVisible(false);lyr_SUNGAI_24.setVisible(true);lyr_SurveyLapang_25.setVisible(false);
var layersList = [lyr_OpenStreetMap_0,lyr_google_1,lyr_Topografi_2,lyr_PrioritasRehabilitasiReplantingTinggimerahSedangkuningRendahHijau_3,lyr_Analisispotensiancamandankonfliklahan_4,lyr_jenis_tanah_5,lyr_TUTUPAN_LAHAN_6,lyr_ZonasiTNKutai_7,lyr_KARET_8,lyr_TANAHTERBUKA_9,lyr_PERTANIAN_LAHAN_KERING_CAMPURAN_10,lyr_BANGUNAN_11,lyr_SAWAH_12,lyr_SAWIT_13,lyr_TAMBAK_14,lyr_Jalan_15,lyr_GeologiLitologi_16,lyr_GeologiStruktur_17,lyr_BatasDas_18,lyr_SubDas_19,lyr_BATASTNKUTAI4194_20,lyr_BATAS_RESORT_TNKUTAI_4194_21,lyr_SK_LOKASi_FSP_22,lyr_RehabDASdiTNKutai_IPPKH_23,lyr_SUNGAI_24,lyr_SurveyLapang_25];
...
lyr_jenis_tanah_5.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'SOIL_GREAT': 'SOIL_GREAT', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_TUTUPAN_LAHAN_6.set('fieldAliases', {'Remark': 'Remark', 'Luas': 'Luas', 'NAME': 'NAME', });
...
lyr_KARET_8.set('fieldAliases', {'Remark': 'Remark', 'Luas': 'Luas', 'NAME': 'NAME', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_TANAHTERBUKA_9.set('fieldAliases', {'Remark': 'Remark', 'Luas': 'Luas', 'NAME': 'NAME', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_PERTANIAN_LAHAN_KERING_CAMPURAN_10.set('fieldAliases', {'Remark': 'Remark', 'Luas': 'Luas', 'NAME': 'NAME', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
...
lyr_jenis_tanah_5.set('fieldImages', {'OBJECTID': 'TextEdit', 'SOIL_GREAT': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_TUTUPAN_LAHAN_6.set('fieldImages', {'Remark': 'TextEdit', 'Luas': 'TextEdit', 'NAME': 'TextEdit', });
...
lyr_KARET_8.set('fieldImages', {'Remark': 'TextEdit', 'Luas': 'TextEdit', 'NAME': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_TANAHTERBUKA_9.set('fieldImages', {'Remark': 'TextEdit', 'Luas': 'TextEdit', 'NAME': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_PERTANIAN_LAHAN_KERING_CAMPURAN_10.set('fieldImages', {'Remark': 'TextEdit', 'Luas': 'TextEdit', 'NAME': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
...
lyr_BATAS_RESORT_TNKUTAI_4194_21.set('fieldImages', {'id_fungsi': 'TextEdit', 'Fungsi': 'TextEdit', 'Nama': 'TextEdit', 'Penunjukan': 'TextEdit', 'Penetapan': 'TextEdit', 'Luas_Ha': 'TextEdit', 'Luas_Res': 'TextEdit', });
lyr_SK_LOKASi_FSP_22.set('fieldImages', {'Id': 'TextEdit', });
lyr_RehabDASdiTNKutai_IPPKH_23.set('fieldImages', {'Id': 'Range', 'NAMA_IPPKH': 'TextEdit', 'SK_DAS': 'TextEdit', 'TGL_DAS': 'TextEdit', 'LUAS_DAS': 'TextEdit', 'KWS_HTN': 'TextEdit', 'ID_BLOK': 'TextEdit', 'PENILAIAN': 'TextEdit', 'PENANAMAN': 'TextEdit', 'LUAS_REAL': 'TextEdit', '2013_HA': 'TextEdit', '2014_HA': 'TextEdit', '2015_HA': 'TextEdit', '2016_HA': 'TextEdit', '2017_HA': 'TextEdit', '2018_HA': 'TextEdit', '2019_HA': 'TextEdit', '2020_HA': 'TextEdit', '2021_HA': 'TextEdit', '2022_HA': 'TextEdit', '2020_TNM': 'TextEdit', });
...
lyr_jenis_tanah_5.set('fieldLabels', {'OBJECTID': 'inline label', 'SOIL_GREAT': 'inline label', 'Shape_Leng': 'inline label', 'Shape_Area': 'inline label', });
lyr_TUTUPAN_LAHAN_6.set('fieldLabels', {'Remark': 'inline label', 'Luas': 'inline label', 'NAME': 'inline label', });
...
lyr_KARET_8.set('fieldLabels', {'Remark': 'no label', 'Luas': 'no label', 'NAME': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_TANAHTERBUKA_9.set('fieldLabels', {'Remark': 'no label', 'Luas': 'no label', 'NAME': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_PERTANIAN_LAHAN_KERING_CAMPURAN_10.set('fieldLabels', {'Remark': 'no label', 'Luas': 'no label', 'NAME': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
...
lyr_BATAS_RESORT_TNKUTAI_4194_21.set('fieldLabels', {'id_fungsi': 'inline label', 'Fungsi': 'inline label', 'Nama': 'inline label', 'Penunjukan': 'inline label', 'Penetapan': 'inline label', 'Luas_Ha': 'inline label', 'Luas_Res': 'inline label', });
lyr_SK_LOKASi_FSP_22.set('fieldLabels', {'Id': 'inline label', });
lyr_RehabDASdiTNKutai_IPPKH_23.set('fieldLabels', {'Id': 'inline label', 'NAMA_IPPKH': 'inline label', 'SK_DAS': 'inline label', 'TGL_DAS': 'inline label', 'LUAS_DAS': 'inline label', 'KWS_HTN': 'inline label', 'ID_BLOK': 'inline label', 'PENILAIAN': 'inline label', 'PENANAMAN': 'inline label', 'LUAS_REAL': 'inline label', '2013_HA': 'inline label', '2014_HA': 'inline label', '2015_HA': 'inline label', '2016_HA': 'inline label', '2017_HA': 'inline label', '2018_HA': 'inline label', '2019_HA': 'inline label', '2020_HA': 'inline label', '2021_HA': 'inline label', '2022_HA': 'inline label', '2020_TNM': 'inline label', });
